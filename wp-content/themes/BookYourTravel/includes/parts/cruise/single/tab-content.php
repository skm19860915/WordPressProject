	...
	<article>
		...
		<?php
			...
			<li id="cabin_type_<?php echo $cabin_type_id; ?>">
				...
				<figure class="left"><img src="<?php echo esc_url($cabin_type_obj->get_main_image('medium')) ?>" alt="<?php echo esc_attr($cabin_type_obj->get_title()); ?>" /><a href="<?php echo esc_url($cabin_type_obj->get_main_image('full')); ?>" class="image-overlay" rel="prettyPhoto[gallery<?php echo esc_attr($cabin_type_id); ?>]"></a></figure>
				<?php } ?>

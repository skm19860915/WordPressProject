...
<script src='https://www.google.com/recaptcha/api.js'></script>
    ...
    function register_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
                ...
                'required' => false, // If false, the plugin is only 'recommended' instead of required.
                'version' => '6.4.6', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
                'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
                'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
                'external_url' => '', // If set, overrides default API URL and points to an external URL.
            ),
    ...
    function enqueue_scripts_styles() {
        ...
        wp_localize_script('bookyourtravel-scripts', 'BYTAjax', array(
            'ajaxurl' => $ajaxurl,
            'slimajaxurl' => BookYourTravel_Theme_Utils::get_file_uri('/includes/theme_custom_ajax_handler.php'),

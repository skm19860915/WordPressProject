...
$fs_table_extra_field_values = $bookyourtravel_tour_helper->list_tour_bookings($paged, $posts_per_page, 'Id', 'ASC', null, $booking_user_id, $is_partner_page ? $current_author_id : null);
